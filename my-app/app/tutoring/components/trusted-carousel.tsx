...
const SCHOOLS_DATA = [
  { name: "Chulalongkorn University", logo: "CU", image: "/logo/chula.svg" },
  {
    ...
    logo: "CU ENG",
    image: "/logo/chula-engineering.png",
  },
  {
    name: "Chula Communication Arts",
    logo: "CU COMMARTS",
    image: "/logo/cu-commarts.png",
  },
  {
    name: "Chula International School of Engineering",
    logo: "CU ISE",
    image: "/logo/cu-ise.png",
  },
    ...
    <div className="w-full py-0 bg-background">
      <div className="container mx-auto px-4 mb-8">
        <h2 className="text-2xl font-sans font-light text-center text-muted-foreground italic">
          <span className="font-serif text-primary not-italic">Trusted</span> by
          students who come <span className="text-green-600">from</span> and{" "}
          <span className="text-green-600">accepted</span> to these institutions
        </h2>
      </div>

      <div className="border-y border-none bg-background">
        <div className="overflow-hidden" ref={emblaRef}>
          <div className="flex touch-pan-y">
            {SCHOOLS.map((school, index) => (
              <div key={index} className="flex-[0_0_250px] min-w-0">
                <Card className="h-40 flex items-center justify-center rounded-none border-0 border-r border-none shadow-none bg-transparent hover:bg-secondary/50 transition-colors duration-600 group">
